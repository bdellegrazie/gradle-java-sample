    ...
    stage("Build") {
      ...
      post {
        always {
          ...
          recordIssues aggregatingResults: true, blameDisabled: true, forensicsDisable: true,
            tool checkstyle, pattern: '**/build/reports/checkstyle/*.xml', reportEncoding: 'UTF-8',
